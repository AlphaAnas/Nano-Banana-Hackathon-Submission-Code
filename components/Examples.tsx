        ...
        {examples.map((ex, index) => (
          <div key={index} className="bg-gray-800/50 rounded-lg p-4 shadow-lg">
            <div className="flex items-center justify-center gap-2">
              <div className="w-full aspect-square rounded-md overflow-hidden ring-1 ring-white/10">
              ...
              <div className="w-full aspect-square rounded-md overflow-hidden ring-1 ring-purple-400/50">
